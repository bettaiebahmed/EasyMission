...
<html lang="en" >
  <head>
    ...
    <!--favicon-->
    <link rel="apple-touch-icon" href="Views/assets/theme/images/apple-touch-icon.png">
    <link rel="shortcut icon" href="Views/assets/theme/images/favicon.ico" type="image/x-icon">

    <!-- bootstrap -->
    <link href="Views/assets/plugins/bootstrap-3.3.2/css/bootstrap.min.css" rel="stylesheet">

    <!-- Icons -->
    <link href="Views/assets/plugins/font-awesome-4.2.0/css/font-awesome.min.css" rel="stylesheet">

    <!-- lightbox -->
    <link href="Views/assets/plugins/magnific-popup/magnific-popup.css" rel="stylesheet">


    <!-- Themes styles-->
    <link href="Views/assets/theme/css/theme.css" rel="stylesheet">  
    <!-- Your custom css -->
    <link href="Views/assets/theme/css/theme-custom.css" rel="stylesheet">
  ...
  <body>
      ...
      <header class="main-header">
        ...
        <div class="hero-header">
          <div class="inner-hero-header">
            <div class="container">
              <div class="text-center logo"> <a href="index.html"><img src="Views/assets/theme/images/logo.png" alt=""></a></div>
              <div class="relative">
    ...
    <script src="Views/assets/plugins/jquery.js"></script>
    <script src="Views/assets/plugins/jquery.easing-1.3.pack.js"></script>
    <!-- jQuery Bootstrap -->
    <script src="Views/assets/plugins/bootstrap-3.3.2/js/bootstrap.min.js"></script>
    <!-- Lightbox -->
    <script src="Views/assets/plugins/magnific-popup/jquery.magnific-popup.min.js"></script>
    <!-- Theme JS -->
    <script src="Views/assets/theme/js/theme.js"></script>

    <!-- maps -->
    <script src="http://maps.googleapis.com/maps/api/js?sensor=false" type="text/javascript"></script> 
    <script src="Views/assets/plugins/gmap3.min.js"></script>
    <!-- maps single marker -->
    <script src="Views/assets/theme/js/map-detail.js"></script>
